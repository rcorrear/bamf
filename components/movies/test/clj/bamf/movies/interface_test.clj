...
(deftest family-tree-module-test
  (with-open [ipc (rtest/create-ipc)]
    (rtest/launch-module! ipc movies/FamilyTreeModule {:tasks 4 :threads 2})
    (let [module-name (get-module-name movies/FamilyTreeModule)
          ...
          p13 (UUID/randomUUID)
          p14 (UUID/randomUUID)]
      (foreign-append! people-depot (movies/->Person p1 nil nil "Person 1"))
      (foreign-append! people-depot (movies/->Person p2 nil nil "Person 2"))
      (foreign-append! people-depot (movies/->Person p3 nil nil "Person 3"))
      (foreign-append! people-depot (movies/->Person p4 nil nil "Person 4"))
      (foreign-append! people-depot (movies/->Person p5 nil nil "Person 5"))
      (foreign-append! people-depot (movies/->Person p6 nil nil "Person 6"))
      (foreign-append! people-depot (movies/->Person p7 p1 p2 "Person 7"))
      (foreign-append! people-depot (movies/->Person p8 p3 p4 "Person 8"))
      (foreign-append! people-depot (movies/->Person p9 p1 p5 "Person 9"))
      (foreign-append! people-depot (movies/->Person p10 p7 p8 "Person 10"))
      (foreign-append! people-depot (movies/->Person p11 p9 p10 "Person 11"))
      (foreign-append! people-depot (movies/->Person p12 p10 p11 "Person 12"))
      (foreign-append! people-depot (movies/->Person p13 p10 p11 "Person 13"))
      (foreign-append! people-depot (movies/->Person p14 p10 p11 "Person 14"))
