...
- [X] T039 [P] Update verification notes and fixture references in `/specs/005-save-request-metadata/quickstart.md`
- [X] T040 [P] Document observability scope (print-event logs only; no metrics/traces for this feature) in `/specs/005-save-request-metadata/quickstart.md`
